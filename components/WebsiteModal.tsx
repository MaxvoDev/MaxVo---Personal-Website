    ...
    return (
        <Modal 
            ...
            <div className="px-10 flex flex-col  h-full overflow-y-scroll pb-10">
                <p>I made this website in a few weeks of on and off coding. I decided to make a portfolio in order to expand my knowledge in React since my role at Motorola Solutions was based mainly on the Angular framework for frontend work.</p>
